namespace AddressRegistry.StreetName.Events
{
    ...
    public class AddressRetirementWasCorrected : IStreetNameEvent, IHasAddressPersistentLocalId
    {
        public const string EventName = "AddressRetirementWasCorrected"; // BE CAREFUL CHANGING THIS!!
        ...
        public AddressRetirementWasCorrected(
        ...
        [JsonConstructor]
        private AddressRetirementWasCorrected(
