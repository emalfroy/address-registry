namespace AddressRegistry.StreetName.Events
{
    ...
    public class AddressPositionWasChanged : IStreetNameEvent, IHasAddressPersistentLocalId
    {
        ...
        [EventPropertyDescription("Specificatie van het object dat voorgesteld wordt door de adrespositie. Mogelijkheden: Municipality, Street, Parcel, Lot, Stand, Berth, Building, BuildingUnit, Entry of RoadSegment.")]
            ...
            ExtendedWkbGeometry? extendedWkbGeometry)
        {
            ...
            GeometryMethod = geometryMethod;
            GeometrySpecification = geometrySpecification;
            ExtendedWkbGeometry = extendedWkbGeometry ?? string.Empty;
        }
