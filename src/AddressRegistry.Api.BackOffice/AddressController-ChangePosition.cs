namespace AddressRegistry.Api.BackOffice
{
    ...
    public partial class AddressController
    {
        ...
        /// <response code="202">Aanvraag tot wijziging adrespositie wordt reeds verwerkt.</response>
        /// <response code="400">Als de adres status niet 'voorgesteld' of 'ingebruik' is.</response>
        /// <response code="412">Als de If-Match header niet overeenkomt met de laatste ETag.</response>
        /// <returns></returns>
        [HttpPost("{persistentLocalId}/acties/wijzigen/adrespositie")]
        ...
        public async Task<IActionResult> ChangePosition(
            ...
            [FromRoute] AddressChangePositionRequest request,
