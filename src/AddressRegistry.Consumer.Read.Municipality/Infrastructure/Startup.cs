                ...
                .ConfigureDefaultForApi<Startup>(new StartupConfigureOptions
                {
                    ...
                    Swagger =
                    {
                        ApiInfo = (provider, description) => new OpenApiInfo
                        {
                            ...
                            Title = "Basisregisters Vlaanderen Address Registry Consumer Municipality API",
                    ...
                    MiddlewareHooks =
                    {
                        ...
                        AfterHealthChecks = health =>
                        {
                            ...
                            health.AddDbContextCheck<MunicipalityConsumerContext>(
                                $"dbcontext-{nameof(MunicipalityConsumerContext).ToLowerInvariant()}",
                                tags: new[] {DatabaseTag, "sql", "sqlserver"});
                        }
                    }
                });
            ...
            app
                ...
                .UseDefaultForApi(new StartupUseOptions
                {
                    ...
                    Api =
                    {
                        ...
                        Info = groupName => $"Basisregisters.Vlaanderen - Address Information Registry Consumer Municipality API {groupName}",
                        CSharpClientOptions =
                        {
